...
parfor i = 1:20
    ...
    for r = 1:length(setParameters)
        ...
        for pos = 1:5
            ...
            SVMDigitClass = SVMAlternativeDigitClassificator("polynomial", maxIterNumb, rAux);
            ...
            [SVMDigitClass, trainError, testError] = SVMDigitClass.classificationError(auxTestLabels);
    ...
    bestParameter = setParameters(positionParameter);
    SVMDigitClass = SVMAlternativeDigitClassificator("polynomial", maxIterNumb, bestParameter(1));
    SVMDigitClass = SVMDigitClass.train(trainSet, trainLabels);
    SVMDigitClass = SVMDigitClass.evaluateTestSet(testLabels, testSet);
    [SVMDigitClass, trainError, testError] = SVMDigitClass.classificationError(testLabels);
    testErrors(1, i) = testError;
    optimalParameters(1, i) = bestParameter(1);
end
save('Q1_6_cross_val.mat', 'testErrors', 'optimalParameters');